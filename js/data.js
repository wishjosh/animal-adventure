...
const openingScenes = [
  ...
  { emoji:'⭐', text:'지도 뒷면에 한 줄이 적혀 있었어요.<br>"초록별이 아파하고 있어.<br>네가 수호대를 모아야 해."', btn:'다음 →' },
  { emoji:'🌳', text:'초록 마을 한가운데 오래된 고목나무가<br>잎을 다 떨군 채 시들어가고 있어요.<br>힌트: 모든 생태계의 기초는 생산자와<br>분해자예요. 뿌리부터 살려보세요!', btn:'탐험 시작하기 →' }
];
